...
export const caseStudies: CaseStudy[] = [
  {
    ...
    subtitle: "Helping a pharmaceutical quality consultant grow awareness, gain traction, and build thought leadership.",
    logoUrl: "/CQS.svg",
  ...
  },
  {
    id: "zoll",
    name: "ZOLL",
    subtitle: "Built award-winning corporate communications programs and thought leadership.",
    logoUrl: "/Zoll.png",
  ...
  {
    id: "radisphere",
    name: "Radisphere National Radiology Group",
    subtitle: "Built brand of a national teleradiology group around accessibility and accountability.",
    logoUrl: "/radisphere.jpeg",
